...
const ProductView = props => {
    ...
    const check = () => {
        ...
        if (furniture === undefined) {
            alert('Vui lòng chọn màu sắc nội thất!')
            return false
        }
        ...
        <div className="product">
            <div className="product__images">
                ...
                <div className={`product-description ${descriptionExpand ? 'expand' : ''}`}>
                    ...
                    <div className="product-description__toggle">
                        <Button furniture="sm" onClick={() => setDescriptionExpand(!descriptionExpand)}>
                            {
            ...
            <div className="product__info">
                ...
                <div className="product__info__item">
                    ...
                    <div className="product__info__item__list">
                        {
                            product.furniture.map((item, index) => (
                                <div key={index} className={`product__info__item__list__item ${furniture === item ? 'active' : ''}`} onClick={() => setFurniture(item)}>
                                    <div className={`circle bg-${item}`}></div>
                                </div>
                            ))
                        }
                ...
                <div className="product__info__item">
                    <Button onClick={() => addToCart()}>đặt hàng ngay</Button>
