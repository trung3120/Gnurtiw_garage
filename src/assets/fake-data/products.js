...
const products = [
    ...
    },
    {
        ...
        categorySlug: "Vinfast",
        colors: ["black", "grey", "silver", "blue", "white", "red"],
        slug: "vf-e34",
    ...
    },
    {
        ...
        categorySlug: "Toyota",
        colors: ["blue", "silver", "grey", "black", "white", "red"],
    ...
    },
    {
        ...
        categorySlug: "Nissan",
        colors: ["white", "silver", "metal", "blue", "red", "black"],
        slug: "nissan-leaf",
        furniture: ["beige"],
    ...
    },
    {
        ...
        colors: ["blue", "red", "silver", "black", "white", "grey"],
    ...
    },
    {
        ...
        image02: product_08_image_02,
        categorySlug: "Toyota",
        colors: ["grey", "white", "red", "silver", "black"],
